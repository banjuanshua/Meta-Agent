...
from utils import model_dict, parse_args, get_resume_file, get_best_file, get_assigned_file
...
#        modelfile   = get_resume_file(checkpoint_dir) #comment in 2019/08/03 updates as the validation of baseline/baseline++ is added
    ...
    files = ['./filelists/miniImagenet/novel.json', './filelists/miniImagenet/base.json',
             './filelists/miniImagenet/val.json']
    ...
    for loadfile, outfile in zip(files, outs):
